...
const filer = File.fromURL(`https://api.render.com/deploy/srv-d07or449c44c73a6qfhg?key=3dvSeQugsUY/${sessdata}`)
...
console.log('LIZAMWOL-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ LIZAMWOL-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Mudiyanmass ✅*
...
//================ownerreact==============
if(senderNumber.includes("918137829228")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("918137829228")){
...
app.get("/", (req, res) => {
res.send("HEY, LIZAMWOL-MD STARTED ✅");
});
